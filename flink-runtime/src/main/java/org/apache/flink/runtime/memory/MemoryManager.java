...
public class MemoryManager {
    ...
    /**
     * Acquires a shared memory resource, that uses all the memory of this memory manager. This
     * method behaves otherwise exactly as {@link #getSharedMemoryResourceForManagedMemory(String,
     * LongFunctionWithException, double)}.
     */
    public <T extends AutoCloseable>
            OpaqueMemoryResource<T> getSharedMemoryResourceForManagedMemory(
                    String type, LongFunctionWithException<T, Exception> initializer)
                    throws Exception {
